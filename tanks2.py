...
class Player(Tank):
	...
	def autoFire(self):
		...
		if self.direction == self.DIR_DOWN and self.rect.left > 176 and self.rect.left < 256:
			return
		elif self.direction == self.DIR_RIGHT and self.rect.top > 352 and self.rect.left < 176:
			return
		elif self.direction == self.DIR_LEFT and self.rect.top > 352 and self.rect.left > 256:
			return
		else:
			for enemy in enemies:
