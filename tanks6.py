...
class Player(Tank):
	...
	def heuristic(self,position):
		...
		heuristic_value = nearest_enemy - lowest_enemy + bonus_value
	...
	def aStarSearch(self):
		...
		while not fringe.isEmpty():
			...
			if self.isGoalState(node):
				print "self",self.rect.topleft, "node: " ,node, "cost of actions: ",self.getCostOfActions(actions), "Heuristic: ", self.heuristic(node)
				return actions
